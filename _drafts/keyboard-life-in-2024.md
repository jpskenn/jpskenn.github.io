...
今年、2024年10月に[SandyLP](https://github.com/jpskenn/SandyLP)が完成しました。  
前作[Sandy](https://github.com/jpskenn/Sandy)の改良版で、約1年半ぶりの新作となります。

〓写真

ざっくりとした変更点は、

- Choc V2スイッチの採用でキーボード全体を低く抑える
- レイアウトを40%相当のキー数に変更して微調整
- MCUをRP2040へ乗せ換え

といったところですが、完成した瞬間から新たな*End Game*が始まり、たいへん満足しています。  

一部のMX軸のキーキャップはChoc V2スイッチやスイッチプレートと干渉するため使えませんが、お気に入りのDSSとKATは以下の組み合わせで使えているので助かっています。  
（KATはスイッチに多少当たっているようだけど、気にならないレベル。）

- Kailh Deep Sea Silent MINI + Signature Plastics, DSS, Solarized Dark
- Kailh Lofree FLOW GHOST + Keyreative, KAT, Space Cadet

今回、GH60型ケース*非対応*としたことで様々な制約から解放され、ある意味で自由な開発をおこなうことができたのは新鮮な体験でした。
